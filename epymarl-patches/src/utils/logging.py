...
class Logger:
    ...
    def setup_wandb(self, config, team_name, project_name, mode):
        ...
        assert project_name is not None, (
            "W&B logging requires `wandb_project` in config "
            "(entity defaults to your `wandb login` account if `wandb_team` is null)."
        )
        assert (
        ...
        self.wandb = wandb.init(
            entity=team_name,  # None → default entity from `wandb login`
